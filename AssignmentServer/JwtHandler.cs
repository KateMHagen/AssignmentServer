...
namespace AssignmentServer;

public class JwtHandler(IConfiguration configuration, UserManager<BooksPublishersUser> userManager)
{
    public async Task<JwtSecurityToken> GetTokenAsync(BooksPublishersUser user) =>
    new(
    ...
    private async Task<List<Claim>> GetClaimsAsync(BooksPublishersUser user)
    {
